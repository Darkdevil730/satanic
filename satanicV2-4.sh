...
baner(){
    ...
    echo '  Versi : 2.4' | lolcat
    echo '  Total : 70 Tools' | lolcat
...
'
    ...
    01)clear
    echo 'Tools Installer V 2.4' | lolcat
    echo 'Laporkan bila terjadi bug' | lolcat
    echo 'Apa yg baru?' | lolcat
    echo 'Memperbaiki bug yg terjadi dan menambahkan di v2.3' | lolcat
