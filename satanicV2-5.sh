...
baner(){
    ...
    echo '  Versi : 2.5' | lolcat
    echo '  Total : 75 Tools' | lolcat
...
'
    ...
    01)clear
    echo 'Tools Installer V 2.5' | lolcat
    echo 'Laporkan bila terjadi bug' | lolcat
    echo 'Apa yg baru?' | lolcat
    echo 'Memperbaiki bug yg terjadi dan menambahkan di v2.4' | lolcat
