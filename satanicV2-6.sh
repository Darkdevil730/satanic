...
baner(){
    ...
    echo '  Versi : 2.6' | lolcat
    echo '  Total : 83 Tools' | lolcat
...
'
    ...
    01)clear
    echo 'Tools Installer V 2.6' | lolcat
    echo 'Laporkan bila terjadi bug' | lolcat
    echo 'Apa yg baru?' | lolcat
    echo 'Memperbaiki bug yg terjadi dan menambahkan di v2.5' | lolcat
    ...
    echo -n "[+] Pesan : "
    read gas1
    xdg-open https://wa.me/send/phone?=6289652884613&text=$gas1
    sleep 3
    clear
    baner
    menu
