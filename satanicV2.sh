...
baner(){
    ...
    echo '  Versi : 2.0' | lolcat
    echo '  Total : 38 Tools' | lolcat
...
'
    ...
    ls
    echo '[*] Example : ./xerxes(nama website) 80' | lolcat
    sleep 3
    echo ''
    ...
    01)clear
    echo 'Tools Installer v 2.0' | lolcat
    echo 'Laporkan bila terjadi bug' | lolcat
    echo 'Apa yg baru?' | lolcat
    echo 'Memperbaiki bug yg terjadi dan menambahkan di v1.10' | lolcat
